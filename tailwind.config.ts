...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'soft': '0 2px 20px -3px rgba(0, 0, 0, 0.05), 0 10px 30px -2px rgba(0, 0, 0, 0.03)',
        'cta': '0 8px 30px -6px hsl(var(--primary) / 0.4)',
        'card': '0 4px 25px -5px rgba(0, 0, 0, 0.08)',
        'card-hover': '0 20px 50px -12px rgba(0, 0, 0, 0.15)',
        'ai': '0 8px 40px -8px hsl(var(--color-ai) / 0.3)',
