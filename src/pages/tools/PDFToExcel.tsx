...
const PDFToExcel = () => (
  <>
    <Helmet>
      <title>PDF to Excel - Convert PDF to XLSX Online</title>
      <meta name="description" content="Convert PDF tables to Excel spreadsheets online. Free PDF to XLSX converter." />
    </Helmet>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-green/10 mb-4">
              <Table className="w-8 h-8 text-brand-green" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">PDF to Excel</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Convert PDF tables to spreadsheets.</p>
          </div>
