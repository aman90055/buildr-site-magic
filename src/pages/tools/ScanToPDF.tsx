  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Convert scanned documents and images to PDF. Free online scan to PDF converter." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Scan to PDF - Convert Scanned Images to PDF | Free Tool" />
        <meta name="twitter:description" content="Convert scanned documents and images to PDF. Free online scan to PDF converter." />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org", "@type": "HowTo",
          name: "Scan to PDF - Convert Scanned Images to PDF | Free Tool", description: "Convert scanned documents and images to PDF. Free online scan to PDF converter.",
          totalTime: "PT1M",
          step: [
