  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Image to Text (OCR) | PDF Tools" />
        <meta property="og:description" content="Extract text from images with AI OCR. Copy or download as TXT/JSON." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Image to Text (OCR) | PDF Tools" />
        <meta name="twitter:description" content="Extract text from images with AI OCR. Copy or download as TXT/JSON." />
      </Helmet>
