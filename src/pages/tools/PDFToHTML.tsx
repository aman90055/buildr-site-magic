  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Convert PDF documents to clean HTML pages. Free PDF to HTML converter." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="${file.name}" />
        <meta name="twitter:description" content="Convert PDF documents to clean HTML pages. Free PDF to HTML converter." />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org", "@type": "HowTo",
          name: "${file.name}", description: "Convert PDF documents to clean HTML pages. Free PDF to HTML converter.",
          totalTime: "PT1M",
          step: [
