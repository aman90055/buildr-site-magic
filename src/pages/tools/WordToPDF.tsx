...
const WordToPDF = () => (
  <>
    <Helmet>
      <title>Word to PDF - Convert DOCX to PDF Online Free</title>
      <meta name="description" content="Convert Word documents to PDF online. Free DOCX to PDF converter." />
    </Helmet>
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Word to PDF</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Convert Word documents to PDF format.</p>
          </div>
