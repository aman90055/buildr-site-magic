  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Convert PDF pages to presentation slides. Free PDF to slide converter." />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="PDF to PowerPoint - Convert PDF Slides Online" />
        <meta name="twitter:description" content="Convert PDF pages to presentation slides. Free PDF to slide converter." />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org", "@type": "HowTo",
          name: "PDF to PowerPoint - Convert PDF Slides Online", description: "Convert PDF pages to presentation slides. Free PDF to slide converter.",
          totalTime: "PT1M",
          step: [
