...
const PDFToPDFA = () => (
  <>
    <Helmet>
      <title>PDF to PDF/A - Convert to Archive Format Online</title>
      <meta name="description" content="Convert PDF to PDF/A archive format for long-term preservation. Free PDF/A converter." />
    </Helmet>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-purple/10 mb-4">
              <FileArchive className="w-8 h-8 text-brand-purple" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">PDF to PDF/A</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Convert to archive format for long-term preservation.</p>
          </div>
