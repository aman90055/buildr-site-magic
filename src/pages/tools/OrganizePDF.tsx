...
const OrganizePDF = () => (
  <>
    <Helmet>
      <title>Organize PDF - Rearrange PDF Pages Online</title>
      <meta name="description" content="Organize and rearrange pages in your PDF documents. Free online PDF organizer." />
    </Helmet>
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Rearrange pages in your PDF documents.</p>
          </div>
