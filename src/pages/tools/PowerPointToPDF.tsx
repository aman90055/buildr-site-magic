...
const PowerPointToPDF = () => (
  <>
    <Helmet>
      <title>PowerPoint to PDF - Convert PPTX to PDF Online</title>
      <meta name="description" content="Convert PowerPoint presentations to PDF online. Free PPTX to PDF converter." />
    </Helmet>
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">PowerPoint to PDF</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Convert presentations to PDF format.</p>
          </div>
