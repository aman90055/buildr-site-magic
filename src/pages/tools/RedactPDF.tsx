...
const RedactPDF = () => (
  <>
    <Helmet>
      <title>Redact PDF - Black Out Sensitive Information Online</title>
      <meta name="description" content="Redact and black out sensitive information in PDF documents. Free PDF redaction tool." />
    </Helmet>
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Black out sensitive information in your PDFs.</p>
          </div>
