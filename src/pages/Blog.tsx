...
const Blog = () => {
  ...
  const blogPosts = [
    ...
    // ===== Hindi posts (India SEO) =====
    {
      title: "PDF Kaise Merge Karein - Free Online Tool (2026 Guide)",
      excerpt: "Sirf 3 step me multiple PDF files ko ek single document me combine karna seekhein - bilkul free.",
      date: "April 1, 2026",
      readTime: "5 min read",
      category: "Hindi",
      icon: FileText,
      slug: "pdf-kaise-merge-karein",
      image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=600&auto=format&fit=crop&q=60",
    },
    {
      title: "PDF Compress Online Free - File Size 90% Tak Kam Karein",
      excerpt: "PDF file size kaise kam karein bina quality lose kiye - free online tool.",
      date: "April 2, 2026",
      readTime: "6 min read",
      category: "Hindi",
      icon: Zap,
      slug: "pdf-compress-online-free-hindi",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=600&auto=format&fit=crop&q=60",
    },
    {
      ...
      category: "Hindi",
      icon: FileText,
      slug: "pdf-split-kaise-karein",
      image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=60",
    },
    {
      title: "PDF Ko Word Me Convert Kaise Karein - Free Online (Hindi)",
      excerpt: "PDF se Word document banana, formatting preserve karke - bina kisi software ke.",
      date: "April 4, 2026",
      readTime: "5 min read",
      category: "Hindi",
      icon: FileText,
      slug: "pdf-ko-word-me-convert-karein",
    ...
    },
    {
      ...
      category: "Hindi",
      icon: Sparkles,
      slug: "pdf-rotate-online",
      image: "https://images.unsplash.com/photo-1580920461931-fcb03a940df5?w=600&auto=format&fit=crop&q=60",
    },
    {
      ...
      category: "Hindi",
      icon: Zap,
      slug: "scan-to-pdf-mobile",
      image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=600&auto=format&fit=crop&q=60",
    },
    {
      title: "PDF Me Password Kaise Lagayein - Free Encryption Tool",
      excerpt: "Apne sensitive PDF documents ko password se protect karein - bank statements, contracts.",
      date: "April 8, 2026",
      readTime: "4 min read",
      category: "Hindi",
      icon: Shield,
      slug: "pdf-password-protect-hindi",
      image: "https://images.unsplash.com/photo-1563986768609-322da13575f2?w=600&auto=format&fit=crop&q=60",
    },
    {
      ...
      category: "Hindi",
      icon: Shield,
      slug: "pdf-unlock-karein",
      image: "https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=600&auto=format&fit=crop&q=60",
    },
    {
      title: "PDF Se Text Extract Kaise Karein - OCR Free Tool (Hindi)",
      excerpt: "Scanned PDF aur images se text extract karein - Hindi, English aur 100+ languages support.",
      date: "April 10, 2026",
      readTime: "5 min read",
      category: "Hindi",
      icon: Sparkles,
      slug: "pdf-text-extract-hindi",
      image: "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=600&auto=format&fit=crop&q=60",
    },
  ];

  const categories = ["All", "Hindi", "Tutorial", "Product Update", "Feature Guide", "Security", "Productivity"];
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://avwebservices.online/blog" />
        ...
        <meta property="og:url" content="https://avwebservices.online/blog" />
      </Helmet>
