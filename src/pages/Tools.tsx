...
export default function Tools() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>All Tools — Search 74 PDF, AI & Image Tools | The Docunova AI Suite</title>
        ...
        <meta property="og:title" content="All Tools — Search 74 PDF, AI & Image Tools" />
        <meta property="og:description" content="Find the right tool in seconds. Instant search across 74 free PDF, AI and image tools." />
      </Helmet>
