...
const blogPostsData: Record<string, {
  ...
  "secure-business-documents": {
    ...
    content: [
      ...
      "**2. Encryption**",
      "Use AES-256 encryption for maximum security. Our Protect PDF tool applies AES-256 encryption to your documents.",
      "**3. Watermarking**",
      ...
      "## Our Security Tools",
      "Docunova provides these security features:",
