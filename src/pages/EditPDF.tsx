...
const EditPDF = () => {
  return (
    <>
      <Helmet>
        <title>Edit PDF Online - Add Text, Images & Annotations</title>
        <meta
          name="description"
          content="Edit your PDF files online. Add text, images, and annotations to your documents. Free PDF editor tool."
        />
      </Helmet>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-card border border-border rounded-2xl p-12 text-center animate-fade-in-up">
                ...
                <p className="text-muted-foreground mb-8">
                  Our PDF editing feature is currently under development. In the meantime, try our other powerful tools!
                </p>
